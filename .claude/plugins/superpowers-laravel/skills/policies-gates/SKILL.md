...
allowed-tools:
  ...
  - Glob
  - Grep
description: Strengthen Laravel validation/auth/authorization boundaries with explicit failure-safe implementation patterns. Use for policies gates tasks.
---
