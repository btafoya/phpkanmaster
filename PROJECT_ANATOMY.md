...
Generated: 2026-04-10 | 222 files | ~283.8K tokens if all read
...
| docs/superpowers/archive/plans/2026-04-09-recurring-tasks.md | 1403 | 11.7K | docs |
...
| docs/superpowers/archive/plans/2026-04-08-laravel-bootstrap-auth.md | 713 | 5.9K | docs |
| docs/superpowers/archive/plans/2026-04-08-kanban-ui.md | 664 | 5.5K | docs |
...
| docs/superpowers/specs/2026-04-08-kanban-design.md | 514 | 4.3K | docs |
| .claude/skills/bootstrap-overview/references/build-tools.md | 502 | 4.2K | docs |
| .claude/plugins/superpowers-laravel/skills/testing-database/reference.md | 495 | 4.1K | docs |
| docs/superpowers/archive/plans/2026-04-08-kanban-docker-infra.md | 459 | 3.8K | docs |
...
| docs/superpowers/archive/plans/2026-04-09-parent-child-tasks.md | 390 | 3.3K | docs |
| docs/superpowers/archive/specs/2026-04-08-kanban-recurring-tasks.md | 362 | 3.0K | docs |
...
| docs/superpowers/archive/plans/2026-04-08-postgrest-api.md | 318 | 2.6K | docs |
| docs/superpowers/archive/specs/2026-04-09-parent-child-tasks.md | 316 | 2.6K | docs |
...
| PROJECT_ANATOMY.md | 274 | 2.3K | docs |
...
| LaunchReadinessAudit.md | 117 | 975 | docs |
| .claude/plugins/superpowers-laravel/commands/laravel-controller.md | 108 | 900 | docs |
| .claude/skills/pwa-expert/references/background-sync.md | 108 | 900 | docs |
| .claude/plugins/superpowers-laravel/commands/laravel-tdd-pest.md | 102 | 850 | docs |
...
- Docs: 112 files, ~199.2K tokens
- Style: 3 files, ~5.5K tokens
- Other: 84 files, ~52.1K tokens

## Heaviest files (read these with offset/limit)
1. public/assets/js/app.js — 1426 lines (~13.1K tokens)
2. docs/superpowers/archive/plans/2026-04-09-recurring-tasks.md — 1403 lines (~11.7K tokens)
3. .claude/skills/jquery/SKILL.md — 1013 lines (~8.4K tokens)
4. .claude/skills/bootstrap-components/references/interactive-components.md — 722 lines (~6.0K tokens)
5. docs/superpowers/archive/plans/2026-04-08-laravel-bootstrap-auth.md — 713 lines (~5.9K tokens)
6. docs/superpowers/archive/plans/2026-04-08-kanban-ui.md — 664 lines (~5.5K tokens)
7. .claude/plugins/superpowers-laravel/skills/repository-pattern/reference.md — 627 lines (~5.2K tokens)
8. .claude/skills/bootstrap-components/references/css-custom-properties.md — 569 lines (~4.7K tokens)
9. .claude/plugins/superpowers-laravel/skills/livewire/reference.md — 565 lines (~4.7K tokens)
10. .claude/plugins/superpowers-laravel/skills/cache-strategies/reference.md — 563 lines (~4.7K tokens)
11. .claude/plugins/superpowers-laravel/skills/middleware/reference.md — 549 lines (~4.6K tokens)
12. .claude/plugins/superpowers-laravel/skills/inertia/reference.md — 538 lines (~4.5K tokens)
13. .claude/skills/bootstrap-overview/SKILL.md — 533 lines (~4.4K tokens)
14. .claude/skills/bootstrap-layout/SKILL.md — 527 lines (~4.4K tokens)
15. .claude/skills/bootstrap-components/references/static-components.md — 526 lines (~4.4K tokens)
16. .claude/plugins/superpowers-laravel/skills/eloquent-casts-accessors/reference.md — 522 lines (~4.3K tokens)
17. .claude/plugins/superpowers-laravel/skills/service-providers/reference.md — 519 lines (~4.3K tokens)
18. docs/superpowers/specs/2026-04-08-kanban-design.md — 514 lines (~4.3K tokens)
19. .claude/skills/bootstrap-overview/references/build-tools.md — 502 lines (~4.2K tokens)
